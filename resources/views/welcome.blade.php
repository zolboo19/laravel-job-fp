    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
          <h2 class="mb-5 h3">Зарлагдсан ажлын байрны жагсаалт</h2>
          ...
          <div class="col-md-12 text-center mt-5">
            <a href="{{route('alljobs')}}" class="btn btn-primary rounded py-3 px-5"><span class="icon-plus-circle"></span> Зарлагдсан бүх ажлын байрыг харах</a>
          </div>
        </div>
